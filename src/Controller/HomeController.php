...
use App\Repository\ScheduleRepository; // Add this import
...
{
    #[Route('/', name: 'app_home')]
    public function index(EspacesportifRepository $espaceSportifRepository, GeocodingService $geocodingService, ScheduleRepository $scheduleRepository): Response
    {
        ...
        return $this->render('Home.html.twig', [
            ...
            'schedule' => $scheduleToDisplay, // Add schedule variable
            'isOngoing' => $ongoingSchedule !== null, // Add isOngoing variable
        ]);
    }
}