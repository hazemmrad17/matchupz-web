...
class getSportControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Jk7HJNj'] ?? $container->load('get_ServiceLocator_Jk7HJNjService'))->withContext('App\\Controller\\SportController', $container));
