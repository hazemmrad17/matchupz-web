...
class __TwigTemplate_939ca771bbb9751207043fbfcc20eec9 extends Template
{
        ...
        yield "                            <!-- Bouton d'analyse et conteneur pour les résultats -->
                        ...
                        <div class=\"d-flex justify-content-center gap-2 mt-4\">
                            <button type=\"submit\" class=\"btn btn-primary px-4\" style=\"min-width: 150px;\">
                                ";
        // line 160
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 160, $this->source); })()), "vars", [], "any", false, false, false, 160), "value", [], "any", false, false, false, 160), "id", [], "any", false, false, false, 160)) {
            yield "Mettre à jour";
        } else {
            yield "Créer";
        }
...
{% endblock %}", "materiel/new.html.twig", "C:\\Users\\Hazem Mrad\\Desktop\\integration\\New folder - Copy\\New folder\\matchupz-web-0\\templates\\materiel\\new.html.twig");
    }
}
