...
>
  ...
  <body>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(event) {
          ...
          const password = passwordInput.value.trim(); // Ajout de trim pour gérer les espaces

          let isValid = true;

          // Validation email
          if (!email) {
            addToast('Erreur Email', 'Veuillez remplir le champ email.');
          ...
          if (!password) {
            addToast('Erreur Mot de passe', 'Veuillez remplir le champ mot de passe.');
    ...
    {
        return array (  339 => 215,  333 => 212,  329 => 211,  325 => 210,  321 => 209,  317 => 208,  293 => 187,  245 => 142,  242 => 141,  236 => 140,  226 => 136,  221 => 135,  216 => 134,  212 => 133,  142 => 66,  120 => 47,  116 => 46,  110 => 43,  104 => 40,  98 => 37,  94 => 36,  90 => 35,  84 => 32,  70 => 21,  48 => 1,);
    }
        ...
        <div class=\"authentication-inner\">
          ...
          <div class=\"card\">
            <div class=\"card-body\">
              ...
              <form id=\"formAuthentication\" class=\"mb-3\" action=\"{{ path('app_verif_user') }}\" method=\"POST\">
                <div class=\"mb-3\">
                  <label for=\"username\" class=\"form-label\">Email*</label>
                  <div class=\"input-group input-group-merge\">
                    <span class=\"input-group-text\"><i class=\"bx bx-envelope\"></i></span>
...
</html>", "user/auth.html.twig", "C:\\Users\\amine\\Downloads\\matchupz-web-integration\\matchupz-web-integration\\templates\\user\\auth.html.twig");
    }
}
