...
class __TwigTemplate_c76d528c8c2c468ddae1128bdc4fa1c1 extends Template
{
                ...
                <div class=\"card-body\">
                    {{ form_start(form) }}
                        ...
                        <div class=\"mb-3\">
                            ...
                            <div class=\"input-group\">
                                <span class=\"input-group-text\">€</span>
                                {{ form_widget(form.prix_unitaire, {'attr': {'class': 'form-control', 'placeholder': 'Prix unitaire'}}) }}
                            </div>
                        </div>
                        <div class=\"mb-3\">
...
{% endblock %}", "materiel/new.html.twig", "C:\\Users\\MSI\\Desktop\\matchupz-web-0\\templates\\materiel\\new.html.twig");
    }
}
