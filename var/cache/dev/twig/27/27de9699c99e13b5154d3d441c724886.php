...
class __TwigTemplate_d9954c9ad40c66a249ec9c6b3a38f88c extends Template
{
                            ...
                            <div class=\"col-md-6\">
                                <div class=\"d-flex align-items-center p-2 bg-light rounded-2\">
                                    ...
                                    <div>
                                        ...
                                        <p class=\"mb-0\">";
        // line 118
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "num_telephone", [], "any", true, true, false, 118)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 118, $this->source); })()), "num_telephone", [], "any", false, false, false, 118), "Non défini")) : ("Non défini")), "html", null, true);
        yield "</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class=\"card-footer bg-white border-top-0 p-4 d-flex justify-content-end\">
                        <a href=\"";
        // line 127
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_edit", ["id_user" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 127, $this->source); })()), "id", [], "any", false, false, false, 127)]), "html", null, true);
        yield "\" 
...
";
    ...
    {
        return array (  274 => 127,  262 => 118,  248 => 106,  244 => 104,  238 => 102,  236 => 101,  223 => 91,  211 => 82,  199 => 73,  187 => 64,  175 => 55,  163 => 46,  149 => 35,  143 => 34,  140 => 33,  133 => 28,  125 => 25,  119 => 23,  117 => 22,  100 => 7,  87 => 6,  64 => 4,  41 => 2,);
    }
...
{% endblock %}", "user/profile.html.twig", "C:\\Users\\Hazem Mrad\\Desktop\\integration\\New folder - Copy\\New folder\\matchupz-web-0\\templates\\user\\profile.html.twig");
    }
}
