...
class __TwigTemplate_7abacb046ad6b0b581f736e6b02eb0a2 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("baseF.html.twig", "user/reset_password.html.twig", 1);
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        yield "
                            <div class=\"mb-3\">
                                ";
        // line 24
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 24, $this->source); })()), "resetCode", [], "any", false, false, false, 24), 'row', ["attr" => ["class" => "form-control", "placeholder" => "Entrez le code reçu"]]);
        yield "
                            </div>
                            <div class=\"mb-3\">
                                ";
        // line 27
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 27, $this->source); })()), "newPassword", [], "any", false, false, false, 27), 'row', ["attr" => ["class" => "form-control", "placeholder" => "Entrez votre nouveau mot de passe"]]);
        yield "
                            </div>
                            ";
        // line 29
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 29, $this->source); })()), "_token", [], "any", false, false, false, 29), 'row');
        yield "
        ...
        yield "\" class=\"text-muted small\">Back to Login</a>
                            </div>
                        ";
        // line 35
...
";
    ...
    {
        return array (  207 => 45,  202 => 44,  189 => 43,  171 => 35,  166 => 33,  159 => 29,  154 => 27,  148 => 24,  143 => 22,  140 => 21,  134 => 20,  124 => 16,  119 => 15,  114 => 14,  110 => 13,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
...
{% block title %}Reset Password - MatchupZ{% endblock %}
                ...
                <div class=\"col-lg-4 col-md-6 col-sm-8\">
                    <div class=\"card p-4 shadow-sm\" style=\"max-width: 400px; margin: 0 auto;\">
                        ...
                        {{ form_start(form, {'attr': {'novalidate': 'novalidate'}}) }}
                            <div class=\"mb-3\">
                                {{ form_row(form.resetCode, {'attr': {'class': 'form-control', 'placeholder': 'Entrez le code reçu'}}) }}
                            </div>
                            <div class=\"mb-3\">
                                {{ form_row(form.newPassword, {'attr': {'class': 'form-control', 'placeholder': 'Entrez votre nouveau mot de passe'}}) }}
                            </div>
                            {{ form_row(form._token) }}

                            <div class=\"d-flex justify-content-between align-items-center mb-3\">
                                <button type=\"submit\" class=\"btn btn-primary\">Réinitialiser le mot de passe</button>
                                <a href=\"{{ path('app_user_index') }}\" class=\"text-muted small\">Back to Login</a>
                            </div>
                        {{ form_end(form) }}
                    </div>
                </div>
...
{% endblock %}", "user/reset_password.html.twig", "C:\\Users\\MSI\\Desktop\\matchupz-web-0\\templates\\user\\reset_password.html.twig");
    }
}
