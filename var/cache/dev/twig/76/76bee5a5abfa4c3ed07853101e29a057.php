...
{% block body %}
    ...
    {% block javascripts %}
        ...
        {% endif %}
    {% endblock %}
{% endblock %}", "fournisseur/statistics.html.twig", "C:\\Users\\amine\\Downloads\\matchupz-web-integration\\matchupz-web-integration\\templates\\fournisseur\\statistics.html.twig");
    }
}
