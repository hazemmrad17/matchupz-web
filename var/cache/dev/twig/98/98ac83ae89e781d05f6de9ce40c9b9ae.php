...
class __TwigTemplate_e8811893e4aa938311e239f571aa87e1 extends Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["joueur"]) {
            ...
            yield "                        <li class=\"d-flex mb-4 pb-1\">
                            <div class=\"avatar flex-shrink-0 me-3\">
                                <img src=\"";
            // line 213
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["joueur"], "profilePicture", [], "any", false, false, false, 213)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["joueur"], "profilePicture", [], "any", false, false, false, 213), "html", null, true)) : ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/default-avatar.png"), "html", null, true)));
            yield "\"
...
{% endblock %}", "joueur/statistics.html.twig", "C:\\Users\\Hazem Mrad\\Desktop\\integration\\New folder - Copy\\New folder\\matchupz-web-0\\templates\\joueur\\statistics.html.twig");
    }
}
