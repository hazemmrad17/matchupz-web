...
class __TwigTemplate_102c3cb637e94f85c458917cc3090d88 extends Template
{
        ...
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["espaces"]) || array_key_exists("espaces", $context) ? $context["espaces"] : (function () { throw new RuntimeError('Variable "espaces" does not exist.', 35, $this->source); })())) > 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["espace"]) {
                ...
                yield " personnes</p>
                                ...
                                <a href=\"#\" class=\"btn btn-primary py-2 px-4\"><span>En savoir plus</span></a>
                            </div>
                        </div>
                    ";
                ++$context['loop']['index0'];
...
";
    ...
    {
        return array (  264 => 66,  251 => 65,  235 => 58,  229 => 54,  225 => 52,  205 => 46,  201 => 45,  197 => 44,  193 => 43,  187 => 40,  181 => 38,  164 => 37,  161 => 36,  159 => 35,  156 => 34,  154 => 33,  147 => 29,  126 => 10,  113 => 9,  102 => 6,  89 => 5,  66 => 3,  43 => 1,);
    }
