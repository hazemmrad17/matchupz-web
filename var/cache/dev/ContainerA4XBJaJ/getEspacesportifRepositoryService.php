 ...
 */
class getEspacesportifRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EspacesportifRepository' shared autowired service.
     *
     * @return \App\Repository\EspacesportifRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EspacesportifRepository.php';

        return $container->privates['App\\Repository\\EspacesportifRepository'] = new \App\Repository\EspacesportifRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
