...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Form\\EspacesportifType' => ['privates', 'App\\Form\\EspacesportifType', 'getEspacesportifTypeService', true],
            'App\\Form\\EvaluationPhysiqueType' => ['privates', 'App\\Form\\EvaluationPhysiqueType', 'getEvaluationPhysiqueTypeService', true],
            'App\\Form\\FournisseurType' => ['privates', 'App\\Form\\FournisseurType', 'getFournisseurTypeService', true],
            'App\\Form\\HistoriqueClubType' => ['privates', 'App\\Form\\HistoriqueClubType', 'getHistoriqueClubTypeService', true],
            'App\\Form\\JoueurType' => ['privates', 'App\\Form\\JoueurType', 'getJoueurTypeService', true],
            'App\\Form\\MatchType' => ['privates', 'App\\Form\\MatchType', 'getMatchTypeService', true],
            'App\\Form\\MaterielType' => ['privates', 'App\\Form\\MaterielType', 'getMaterielTypeService', true],
            'App\\Form\\PerformanceJoueurType' => ['privates', 'App\\Form\\PerformanceJoueurType', 'getPerformanceJoueurTypeService', true],
            ...
            'App\\Form\\VideoUploadType' => ['privates', 'App\\Form\\VideoUploadType', 'getVideoUploadTypeService', true],
            ...
            'App\\Form\\EspacesportifType' => '?',
            'App\\Form\\EvaluationPhysiqueType' => '?',
            'App\\Form\\FournisseurType' => '?',
            'App\\Form\\HistoriqueClubType' => '?',
            'App\\Form\\JoueurType' => '?',
            'App\\Form\\MatchType' => '?',
            'App\\Form\\MaterielType' => '?',
            'App\\Form\\PerformanceJoueurType' => '?',
            'App\\Form\\ReservationType' => '?',
            'App\\Form\\ScheduleType' => '?',
            'App\\Form\\SponsorType' => '?',
            'App\\Form\\SportType' => '?',
            'App\\Form\\UserType' => '?',
            'App\\Form\\VideoUploadType' => '?',
