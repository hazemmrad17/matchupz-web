...
class getReservationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.TywzKXU'] ?? $container->load('get_ServiceLocator_TywzKXUService'))->withContext('App\\Controller\\ReservationController', $container));
