...
class getDashboardControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.5zAhzgv'] ?? $container->load('get_ServiceLocator_5zAhzgvService'))->withContext('App\\Controller\\DashboardController', $container));
