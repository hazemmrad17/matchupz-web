 ...
 */
class getEvaluationPhysiqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EvaluationPhysiqueRepository' shared autowired service.
     *
     * @return \App\Repository\EvaluationPhysiqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EvaluationPhysiqueRepository.php';

        return $container->privates['App\\Repository\\EvaluationPhysiqueRepository'] = new \App\Repository\EvaluationPhysiqueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
