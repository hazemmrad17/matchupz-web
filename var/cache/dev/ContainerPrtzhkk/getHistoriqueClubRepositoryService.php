 ...
 */
class getHistoriqueClubRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HistoriqueClubRepository' shared autowired service.
     *
     * @return \App\Repository\HistoriqueClubRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HistoriqueClubRepository.php';

        return $container->privates['App\\Repository\\HistoriqueClubRepository'] = new \App\Repository\HistoriqueClubRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
