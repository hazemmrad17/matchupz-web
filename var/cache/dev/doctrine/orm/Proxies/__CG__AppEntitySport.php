...
class Sport extends \App\Entity\Sport implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'idSport' => [parent::class, 'idSport', null, 16],
        "\0".parent::class."\0".'nomSport' => [parent::class, 'nomSport', null, 16],
        'description' => [parent::class, 'description', null, 16],
        'idSport' => [parent::class, 'idSport', null, 16],
        'nomSport' => [parent::class, 'nomSport', null, 16],
    ];
