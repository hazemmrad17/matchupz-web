 ...
 */
class getPerformanceJoueurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PerformanceJoueurRepository' shared autowired service.
     *
     * @return \App\Repository\PerformanceJoueurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PerformanceJoueurRepository.php';

        return $container->privates['App\\Repository\\PerformanceJoueurRepository'] = new \App\Repository\PerformanceJoueurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
