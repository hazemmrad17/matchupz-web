...
class getAbonnementControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.DZQnY04'] ?? $container->load('get_ServiceLocator_DZQnY04Service'))->withContext('App\\Controller\\AbonnementController', $container));
