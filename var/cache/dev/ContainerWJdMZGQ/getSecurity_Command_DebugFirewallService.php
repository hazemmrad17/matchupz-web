...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.TLRF7BM'] ?? self::get_ServiceLocator_TLRF7BMService($container)), ($container->privates['.service_locator._1SGciK'] ?? $container->load('get_ServiceLocator_1SGciKService')), ['main' => [($container->privates['App\\Security\\GoogleAuthenticator'] ?? $container->load('getGoogleAuthenticatorService')), ($container->privates['App\\Security\\FaceRecognitionAuthenticator'] ?? $container->load('getFaceRecognitionAuthenticatorService'))]], false);
