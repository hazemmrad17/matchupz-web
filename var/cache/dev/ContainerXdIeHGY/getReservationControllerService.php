...
class getReservationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.PWcV3ef'] ?? $container->load('get_ServiceLocator_PWcV3efService'))->withContext('App\\Controller\\ReservationController', $container));
